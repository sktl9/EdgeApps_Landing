                ...
                <div className="lg:min-h-[500px] h-full  flex flex-col lg:flex-row gap-[20px]">
                    <div className="flex lg:w-[40%]  items-center">
                        <div className="flex flex-col gap-[20px]">
                            <span className="text-[14px] pb-4 border-b border-gray-400">{content.team.title}</span>
                            <span className="text-[22px] font-bold  lg:text-[55px] leading-none">{content.team.subtitle}</span>
                            <span className="text-[14px]">{content.team.description}</span>
                    ...
                    <div className="relative w-full lg:w-[60%] h-[500px]">
                        ...
                        <div className="absolute w-[50%] sm:w-[30%] h-[170px] top-[45%] sm:top-[25%]  bg-cyan-300 p-4 rounded-lg shadow-md">
                            <div className="flex gap-2 mb-2">
                                <span className="bg-blue-500 text-white text-sm py-1 px-2 rounded-full">{content.team.blocks[0].location}</span>

                            </div>
                            <p className="text-lg font-semibold">{content.team.blocks[0].title}</p>
                        </div>

                        {/* Блок 2 */}
                        <div className="absolute top-[5%] sm:left-[40%]  w-[50%] sm:w-[35%] h-[180px] bg-green-300 p-4 rounded-lg shadow-md">
                            <div className="flex gap-2 mb-2">
                                <span className="bg-blue-500 text-white text-sm py-1 px-2 rounded-full">{content.team.blocks[1].location}</span>

                            </div>
                            <p className="text-lg font-semibold">{content.team.blocks[1].title}</p>
                        </div>

                        {/* Блок 3 */}
                        <div className="absolute sm:w-[30%] w-[45%] h-[150px] sm:top-[45%] top-[30%] sm:left-[55%] left-[55%] bg-cyan-300 p-4 rounded-lg shadow-md">
                            <div className="flex gap-2 mb-2">
                                <span className="bg-blue-500 text-white text-sm py-1 px-2 rounded-full">{content.team.blocks[2].location}</span>

                            </div>
                            <p className="text-lg font-semibold">{content.team.blocks[2].title}</p>
                        </div>
