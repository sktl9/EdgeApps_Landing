            ...
            <div className="px-[10%] mt-[100px]">
                <div className="flex flex-col gap-[20px]">
                    <div className="flex flex-col  border rounded-[2rem] overflow-hidden">
                        <div className="h-auto p-[50px] flex overflow-hidden flex-col gap-[50px]">
                            <div className="h-[30%] w-full flex flex-row justify-center gap-[50px]">
                            ...
                            <div className="flex flex-col bg-[#f9f9f9] rounded-[2rem] p-10 h-auto w-full lg:hidden gap-[30px]" >
